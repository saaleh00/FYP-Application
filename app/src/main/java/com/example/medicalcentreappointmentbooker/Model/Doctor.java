...
public class Doctor {
    ...
    public Doctor(String doctorName, Integer doctorProfileImage, String doctorID) {
    ...
    public Doctor(String doctorName, String doctorID, String doctorAge, String doctorEmail, Integer doctorProfileImage){
        this.doctorName = doctorName;
        this.doctorID = doctorID;
